...
<html lang="en">
    <head>
        ...
        <title>KM-NRRU ระบบค้นหาข้อมูลกลุ่มความรู้</title>
    </head>
    <body>
            ...
            <div class="row">
              <div class="col-md-1"></div>
                <div class="col-md-10"> <br>
                    <h3>Searching System ระบบค้นหาข้อมูลกลุ่มความรู้</h3>
                    ...
                    //ถ้ามีการส่ง $_GET['q'] 
                          if (isset($_GET['q'])){ 
                            ...
                            $q = "%{$_GET['q']}%";
                            $stmt = $conn->prepare("SELECT * FROM btknowledge WHERE bt_groupid LIKE ?");
                            $stmt->execute([$q]);
                    ...
                    <table class="table table-striped  table-hover table-responsive table-bordered">
                        ...
                        <tbody>
                           ...
                           <?php  foreach($result as $row)  {?>
                            <tr>
                                <td><?= $row['id'];?></td>
                                <td><?= $row['bt_groupid'];?></td>
                                <td><?= $row['bt_groupname'];?></td>
                                <td><?= $row['bt_note'];?></td>
                             </tr>
                            <?php } ?>
                        </tbody>
