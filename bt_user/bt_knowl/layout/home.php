    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">ข้อมูลการความรู้</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<div>
      <?php 
          foreach ($rows as $row) {echo $row['id'].'. <a href=editorinfo?id='.$row['id'].'>'.$row['bt_knowledgepass'].'---'.$row['bt_knowledgename'].'</a><br \>';}
          ?>
</div>
