          ...
          <a href="http://localhost/Project/webproject/bt_user/bt_knowledge/editor">
           ...
           <li class="nav-item">
                  ...
                  <ul id="icons" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                    ...
                    <a href="http://localhost/Project/webproject/bt_user/bt_knowl/editor" class="active">
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <!-- Left side columns -->
        <h1>เพิ่มข้อมูลความรู้</h1>
    <form method='post' action=''>

           <div class="card-body">รหัสความรู้ *
             <input type="title" name="bt_knowledgepass" class="form-control" placeholder="กรอกข้อมูล">
         </div>
         <div class="card-body">ชื่อความรู้	*
             <input type="title" name="bt_knowledgename" class="form-control" placeholder="กรอกข้อมูล">
         </div>
        </div>
