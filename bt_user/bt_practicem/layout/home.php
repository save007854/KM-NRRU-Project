...
<div>
      <?php 
          foreach ($rows as $row) {echo $row['id'].'. <a href=editorinfo?id='.$row['id'].'>'.$row['bt_years'].'---'.$row['bt_bookpractice'].'</a><br \>';}
         ?>
</div>
