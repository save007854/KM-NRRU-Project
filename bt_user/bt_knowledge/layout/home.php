  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <!-- Left side columns -->
        <h1>ข้อมูลกลุ่มความรู้</h1>
<div>
      <?php 
          foreach ($rows as $row) {echo $row['id'].'. <a href=editorinfo?id='.$row['id'].'>'.$row['bt_groupid'].'---'.$row['bt_groupname'].'</a><br \>';}
          ?>
</div>
