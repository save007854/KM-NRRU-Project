...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <a href="http://localhost/Project/webproject/bt_user/bt_knowledge/editor" class="active">
  ...
  <main id="main" class="main">
    ...
    <form method='post' action=''>
           ...
           <div class="card-body">รหัสกลุ่ม *
             <input type="title" name="bt_groupid" class="form-control" placeholder="กรอกข้อมูล">
         </div>
         <div class="card-body">ชื่อกลุ่ม	*
             <input type="title" name="bt_groupname" class="form-control" placeholder="กรอกข้อมูล">
         </div>
         <div class="card-body">หมายเหตุ *
             <input type="title" name="bt_note" class="form-control" placeholder="กรอกข้อมูล">
         </div>
        </div>
