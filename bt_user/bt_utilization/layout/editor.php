    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="icons-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <a href="http://localhost/Project/webproject/bt_user/bt_utilization/editor" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">เพิ่มข้อมูลการใช้ประโยชน์</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <!-- Left side columns -->
        <h1>เพิ่มข้อมูลการใช้ประโยชน์</h1>
    <form method='post' action=''>

           <div class="card-body">ลำดับการใช้ประโยชน์ *
             <input type="title" name="bt_utilizationorder" class="form-control" placeholder="กรอกข้อมูล">
         </div>
         <div class="card-body">ปี พ.ศ. *
             <input type="title" name="bt_years" class="form-control" placeholder="กรอกข้อมูล">
         </div>
         <div class="card-body">ชื่อหน่วยงานการใช้ประโยชน์ *
             <input type="title" name="bt_utilizaname" class="form-control" placeholder="กรอกข้อมูล">
         </div>

      <div class="card-body">เชิงวิชาการ *
         <textarea id='editor' name='bt_academic' ></textarea>
        </div>
     <div class="card-body">เชิงสาธารณะ	*
         <textarea id='editor1' name='bt_public' ></textarea>
        </div>
      <div class="card-body">เชิงนโยบาย	*
         <textarea id='editor2' name='bt_policy' ></textarea>
      </div>
      <div class="card-body">เชิงพาณิชย์ *
         <textarea id='editor3' name='bt_commercial' ></textarea>
        </div>
