    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="icons-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
            <a href="http://localhost/Project/webproject/bt_user/bt_utilization/home" class="active">
...
<div>
      <?php 
          foreach ($rows as $row) {echo $row['id'].'. <a href=editorinfo?id='.$row['id'].'>'.$row['bt_years'].'---'.$row['bt_utilizaname'].'</a><br \>';}
          ?>
</div>
