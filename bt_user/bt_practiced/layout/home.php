  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">ข้อมูลแนวปฏิบัติที่ดี</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <!-- Left side columns -->
        <h1>ข้อมูลแนวปฏิบัติที่ดี</h1>
<div>
      <?php 
          foreach ($rows as $row) {echo $row['id'].'. <a href=editorinfo?id='.$row['id'].'>'.$row['bt_years'].'---'.$row['bt_titleth'].'</a><br \>';}
          ?>
</div>
