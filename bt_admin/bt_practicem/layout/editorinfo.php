    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <a class="nav-link collapsed" href="http://localhost/Project/webproject/login-systeam/admin_page.php">
          ...
          <span>Dashboard</span>
            ...
            <li class="nav-item">
                ...
                <li>
                      <a href="http://localhost/Project/webproject/bt_admin/bt_practicem/home" class="active">
      ...
      <li class="nav-item">
        ...
        <li>
          ...
          <li>
            <a href="http://localhost/Project/webproject/bt_admin/bt_practiced/editorinfo?id=1">
      ...
      <li class="nav-item">
        ...
        <ul id="icons-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="http://localhost/Project/webproject/bt_admin/bt_utilization/editorinfo?id=">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="http://localhost/Project/webproject/bt_admin/bt_knowledge/editorinfo?id=">
              ...
              <li class="nav-item">
                  ...
                  <ul id="icons" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                      <a href="http://localhost/Project/webproject/bt_admin/bt_knowl/editorinfo?id=">
