<?php
   ...
   if(isset($_POST['submit'])){
      ...
      $stmt = $db->prepare('UPDATE btutilization SET `bt_utilizationorder` = :bt_utilizationorder, `bt_years` = :bt_years, `bt_utilizaname` = :bt_utilizaname, `bt_academic` = :bt_academic, `bt_public` = :bt_public
      , `bt_policy` = :bt_policy, `bt_commercial` = :bt_commercial WHERE `id` = :id');
      $stmt->execute(array(
         ':id'=>$id,
