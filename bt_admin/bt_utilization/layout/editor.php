...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="icons-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <a href="http://localhost/Project/webproject/bt_admin/bt_utilization/editor" class="active">
  ...
  <main id="main" class="main">
    ...
    <form method='post' action=''>
           ...
           <input type="text" name="bt_utilizationorder" class="form-control" placeholder="กรอกข้อมูล">
         </div>
         <div class="card-body">ปี พ.ศ. *
             <input type="text" name="bt_years" class="form-control" placeholder="กรอกข้อมูล">
         </div>
         <div class="card-body">ชื่อหน่วยงานการใช้ประโยชน์ *
             <input type="text" name="bt_utilizaname" class="form-control" placeholder="กรอกข้อมูล">
         </div>
