...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <li>
          ...
          <li>
            <a href="http://localhost/Project/webproject/bt_admin/bt_practiced/editor" class="active">
  ...
  <main id="main" class="main">
    ...
    <form method='post' action=''>
      <?php 
          //เชื่อมต่อฐานข้อมูลก้อนที่ 1 
          $condb = mysqli_connect("localhost","root","","bestpractice") or die ("Error : ".mysqli_error($condb));
          mysqli_query($condb, "SET NAMES 'utf8' ");
          date_default_timezone_set('Asia/Bangkok');

          $querydb = "SELECT * FROM btpracticem WHERE id = id;";
          $result = mysqli_query($condb, $querydb);

        
          foreach ($result as $row) {echo $row['bt_bookpractice'].'';}?>
