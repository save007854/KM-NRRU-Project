...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
          ...
          <span>Dashboard</span>
             ...
             <li class="nav-item">
                ...
                <li>
                  ...
                  <li>
                      <a href="http://localhost/Project/webproject/bt_admin/bt_practicem/editor">
      ...
      <li class="nav-item">
        ...
        <li>
             <a href="http://localhost/Project/webproject/bt_admin/bt_practiced/home" class="active">
  ...
  <form method='post' action=''>
      ...
      <div class="card-body">ชื่อเรื่องภาษาอังกฤษ	*
         ...
         <div class="card-body">ที่มาและความสำคัญ * <textarea id='editor' name='bt_source'>
    <?php 
        echo $rows[0]['bt_source'];
    ?>
    </textarea>
      </div>
      <div class="card-body">วัตถุประสงค์ * <textarea id='editor1' name='bt_objective'>
    <?php 
        echo $rows[0]['bt_objective'];
    ?>
       </textarea>
    </div>
      <div class="card-body">กลุ่มเป้าหมาย * <textarea id='editor2' name='bt_targetgroup'>
    <?php 
          echo $rows[0]['bt_targetgroup'];
      ?>
          </textarea> 
    </div>
      <div class="card-body">กระบวนการจัดการความรู้ * <textarea id='editor3' name='bt_process'>
    <?php 
        echo $rows[0]['bt_process'];
    ?>
       </textarea>
    </div>
      <div class="card-body">ผลลัพธ์หรือองค์ความรู้ * <textarea id='editor4' name='bt_result'>
    <?php 
        echo $rows[0]['bt_result'];
    ?>
       </textarea>
    </div>
      <div class="card-body">ปัจจัยสู่ความสำเร็จ * <textarea id='editor5' name='bt_factor'>
    <?php 
        echo $rows[0]['bt_factor'];
    ?>
       </textarea>
    </div>
      <div class="card-body">เครื่องมือ * <textarea id='editor6' name='bt_tool'>
    <?php 
        echo $rows[0]['bt_tool'];
    ?>
       </textarea>
    </div>
      <div class="card-body">อ้างอิง * <textarea id='editor7' name='bt_refer'>
    <?php 
        echo $rows[0]['bt_refer'];
    ?>
       </textarea>
    </div>
    <div class="card-body">กลุ่มแนวปฏิบัติที่ดี	* <textarea id='editor8' name='bt_practicegroup'>
      <?php 
    ...
    <div class="card-body">ผู้รับผิดชอบ * <textarea id='editor9' name='bt_responsible'>
      <?php 
        echo $rows[0]['bt_responsible'];
    ?>
       </textarea>
    </div>
    <div class="card-body">ติดต่อ * <textarea id='editor10' name='bt_contact'>
    <?php 
  ...
  <!-- script ของตัว editor สามารถแก้ไข เพิ่ม ลบข้อมูล -->
<script>
