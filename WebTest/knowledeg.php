...
<body>
	...
	<header class="header-section">
		<a href="index.php" class="site-logo"> 
			<img src="img/nrru-logo.png" alt="Image" style="width:35px;height:45px;">
		</a>
	...
	<!-- หน้าแรก -->
	<section class="hero-section set-bg" data-setbg="img/nrru-scie-02.jpg"> <!-- รูปข้างบน -->
		<div class="container">
			<div class="hero-warp">
				<form class="main-search-form">
					...
					<div class="search-input">
						<input type="text" placeholder="กรอกข้อมูลที่ต้องการค้นหา">
