...
<body>
	...
	<header class="header-section">
		<a href="index.php" class="site-logo">
			<img src="img/nrru-logo.png" alt="Image" style="width:55px;height:65px;">
		</a>
		
		<nav class="header-nav">
			<ul class="main-menu">
				<li><a href="index.php" class="active">Home</a></li> <!-- class active เป็นค่าหลักที่อยู่หน้านั้น -->
				<li><a href="http://localhost/Project/webproject/WebTest/plan-km.php">แผนการจัดการความรู้</a>
					<ul class="sub-menu">
	...
	<!-- หน้าแรก -->
	<section class="hero-section set-bg" data-setbg="img/nrru-scie-3.jpg"> <!-- รูปindexข้างบน -->
		<div class="container">
					...
					<div class="about-text">
						<?php if (isset($posts)): ?>
                                <?php foreach ($posts as $post): ?>
                                        <div class="post">
                                                <h3>
                                                <a href="details.php?id=<?php echo $post['id'] ?>"><?php echo $post['bt_utilizaname'] ?></a></h3>
