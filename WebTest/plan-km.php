...
<body>
	...
	<header class="header-section">
		...
		<nav class="header-nav">
			<ul class="main-menu">
				<li><a href="index.php">Home</a></li> <!-- class active เป็นค่าหลักที่อยู่หน้านั้น -->
				<li><a href="http://localhost/Project/webproject/WebTest/plan-km.php"  class="active">แผนการจัดการความรู้</a>
					<ul class="sub-menu">
				...
				<li><a href="http://localhost/Project/webproject/WebTest/board-km.php">คณะกรรมการจัดการความรู้</a>
					<ul class="sub-menu">
						<li><a href="#">ปี 2566</a></li>
						<li><a href="#">ปี 2565</a></li>
						<li><a href="#">ปี 2564</a></li>
				...
				<li><a href="#">เล่มแนวปฏิบัติที่ดี</a>
					<ul class="sub-menu">
						<li><a href="#">ปี 2566</a></li>
						<li><a href="#">ปี 2565</a></li>
						<li><a href="#">ปี 2564</a></li>
	...
	<!-- หน้าแรก -->
	<section class="hero-section set-bg" data-setbg="img/baner2-km.jpg"> <!-- รูปindexข้างบน -->
		<div class="container">
	...
	<section class="intro-section spad">
		...
		<br>
	      		<p class="m-0 text-center text-black"><h2>แผนการจัดการความรู้</h2></p>
				  
				<center><ul>
				<p class="m-0 text-center text-black"><h4>แผนการจัดการความรู้ 2566 <a href="#">&lt;&lt;คลิกที่นี่&gt;&gt;</a><br>
					แผนการจัดการความรู้ 2565 <a href="#">&lt;&lt;คลิกที่นี่&gt;&gt;</a><br>
					แผนการจัดการความรู้ 2564 <a href="#">&lt;&lt;คลิกที่นี่&gt;&gt;</a><br>
					แผนการจัดการความรู้ 2563 <a href="#">&lt;&lt;คลิกที่นี่&gt;&gt;</a><br>
					แผนการจัดการความรู้ 2562 <a href="#">&lt;&lt;คลิกที่นี่&gt;&gt;</a><br>
					แผนการจัดการความรู้ 2561 <a href="#">&lt;&lt;คลิกที่นี่&gt;&gt;</a><br>
					แผนการจัดการความรู้ 2560-2561 <a href="#">&lt;&lt;คลิกที่นี่&gt;&gt;</a><br>
					แผนการจัดการความรู้ 2557-2559 <a href="#">&lt;&lt;คลิกที่นี่&gt;&gt;</a><br>
					แผนการจัดการความรู้ 2555 <a href="#">&lt;&lt;คลิกที่นี่&gt;&gt;</a><br>
					แผนการจัดการความรู้ 2553 <a href="#">&lt;&lt;คลิกที่นี่&gt;&gt;</a>
				</h3></p></ul></center>
		</div>
	</section>
